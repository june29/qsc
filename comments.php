...
<h3 id="respond">Comments on this entry (<?php comments_number('No comments', '1 comment', '% comments' );?>)</h3>
...
<?php if ('open' == $post->comment_status) : ?>
  ...
  <p><strong>XHTML:</strong> コメント中では以下のタグが使用できます</p>
  <p><small><code><?php echo allowed_tags(); ?></code></small></p>
